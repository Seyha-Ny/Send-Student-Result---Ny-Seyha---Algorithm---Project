...
if __name__ == '__main__':
    with app.app_context():
        db.create_all()
    print(f"Templates dir: {app.template_folder} exists={os.path.exists(app.template_folder)}")
    print(f"Static dir: {app.static_folder} exists={os.path.exists(app.static_folder)}")
